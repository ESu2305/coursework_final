...
public class RegisterServlet extends HttpServlet {
	...
	/*protected void login(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/app_userdetails", "root", "password");
			// Step 4: implement the sql query using prepared
			// statement(https://docs.oracle.com/javase/tutorial/jdbc/basics/prepared.html)
			PreparedStatement ps = con.prepareStatement("select name, password from user_details where name =?, password =?");
